...
/**
 * Ahora debemos solucionar un componente imprescindible de nuestra aplicación
 * y es resolver las peticiones, controlador, método y parámetros, 
 * para ello, abre el archivo Core/App.php y añade el siguiente código.
 */
...
class App
{
    ...
    * @var
    */
	//const NAMESPACE_CONTROLLERS = "\app\controllers\\";		//CONFIGURATION-MVC Asi vino el ejemplo
	const NAMESPACE_CONTROLLERS = "app\controllers\\";			//CONFIGURATION-MVC Funciona en localhost y en lanuzagroup.com

    /**
     * @var
     */
    //const CONTROLLERS_PATH = "../app/controllers/";	//CONFIGURATION-MVC Asi vino el ejemplo
    const CONTROLLERS_PATH = "app/controllers/";		//CONFIGURATION-MVC Funciona en localhost y en lanuzagroup.com
    ...
    {
    	//echo "hey:".APPPATH . '/config/config.ini';
