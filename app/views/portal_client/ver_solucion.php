	  ...
	  <input type="hidden" id="certificar_solucionId_Form"   name="certificar_solucionId_Form"   value='<?= $solucion["solucionId"]; ?>' />
		...
		<div class="form-group">
			...
			<div class="col-sm-4" align="right">
			  <a href="<?= PROJECTURLMENU; ?>portal/home" class="btn btn-warning btn-lg" role="button"
			...
			<div class="col-sm-4" align="center">
			  <button type="submit" class="btn btn-success btn-lg" onclick="javascript:certificar();return false;"
			   data-toggle="tooltip" data-placement="top" title="Dar por Finalizada y Certificar la Soluci&oacute;n ofrecida por el Ingeniero de Soporte">
			...
			<div class="col-sm-4" align="left">
				<button type="button" class="btn btn-info btn-lg" onclick="javascript:expandAll();imprimirReporte();" 
				   data-toggle="tooltip" data-placement="top" title="Imprimir esta p&aacute;gina en PDF | Primero se optimizar&aacute; en formato econ&oacute;mico para Ahorrar tinta.">
