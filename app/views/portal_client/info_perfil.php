...
<div id="wholePage">
	...
	<h4 style="text-align:center; color:<?= RGB_CLIENTE; ?>; margin-top:0px; font-size: 35px; ">
		...
		<?php if ( $total==0 ){ ?>
			<div class="row">
				<div class="col-sm-12" align="center">
					...
					<br/>
					Puede comunicarse con su Partner asociado para la <b>Asignaci&oacute;n de su Equipo</b>
					 (tambi&eacute;n consultando con la Ayuda en el Portal).
				</div>
			</div>
		<?php } else { ?>
