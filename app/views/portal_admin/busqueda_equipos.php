<?php 
	echo "<script>";
	echo " var searchURL4= '" . PROJECTURLMENU . "admin/actualizar_equipo';" ;
	echo "</script>";
...
?>
	...
	<div class="row">
		...
		<div class="col-sm-3" align="right">
			<a href="<?= PROJECTURLMENU; ?>admin/nuevo_inventario">&iquest;No existe el Equipo&quest;: Crear Equipo nuevo</a>
		</div>
	</div>
...
<!-- ================================================================================================================= -->
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_equipo_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>admin/inventario_buscar_equipo">
...
<?php
	echo "<script>";
	echo " var searchURL = '" . PROJECTURLMENU . "admin/inventario_desde_cero';" ;
	echo " var searchURL2= '" . PROJECTURLMENU . "admin/inventario_actualizar';" ;
	echo " var searchURL3= '" . PROJECTURLMENU . "admin/actualizar_teamviewer';" ;
	echo "</script>";
?>
