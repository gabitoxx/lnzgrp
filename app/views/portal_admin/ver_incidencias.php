...
<?php if ( isset($no_incidencias) ){ ?>
	...
	<div class="container">
		<h3>No hay Incidencias/Soportes TI <b>pendientes</b> en el Sistema.
		</h3>
	    ...
	    <table class="col-md-12 table-hover table-striped cf" style="font-size:12px;" border="1">
			<thead class="cf">
				<tr>
					...
					<th width="160px" align="center">Acciones</th>
					<th width="120px" align="center">Nº Equipo<br/>(Usuario)</th>
					<th width="150px" align="center">Empresa</th>
					<th width="100px">Fecha creaci&oacute;n<br/>(A&ntilde;o-Mes-D&iacute;a Hora)</th>
					<th width="450px">Falla:<br/>General</th>
					<th align="center">Falla y<br/>Comentarios</th>
					<th width="100px" align="center">Atendida por <br/>(Ing. de Soporte)</th>
					<th width="100px" align="center">Fecha &uacute;ltima<br/> actualizaci&oacute;n</th>
				</tr>
			</thead>
			<tbody>
				<?php 
				...
				?>
				<tr <?php if($incidencia["falla"]=="Reporte de Visita" || $incidencia["falla"]=="Reporte General de Visita") echo 'class="info" style="background-color: #c0e5f2;"'; ?> >
					...
					<td data-title="Empresa"><?php echo $incidencia["nombreEmpresa"]; ?></td>
					...
					<?php 
						...
						if ( $incidencia["respuestaEsperada"] != null ){
							echo  '<td class="info" data-title="Respuesta del Usuario" width="450px">' . $incidencia["respuestaEsperada"] . '</td>';

						} else if ( $incidencia["enEsperaPor"] != null ){
							echo  '<td class="info" data-title="Ing. espera por" width="450px">' . $incidencia["enEsperaPor"] . '</td>';

						} else {
							echo '<td data-title="Observaciones" width="450px">' . $incidencia["observaciones"] . '</td>';
						}
					?>
					...
					<table class="table table-hover table-striped">
						<tr>
							...
							<td class="active">
								...
								<i>por favor</i> pulse esta opci&oacute;n para indicarle al Sistema que se ha
				...
				<div class="col-sm-offset-2 col-sm-10">
					<table class="table table-hover table-striped">
						<tr>
							...
							<td><b>Ya se encuentra Resuelto el inconveniente</b> y se ha <b>Certificado</b>
								la Soluci&oacute;n ofrecida por el Ingeniero de Soporte como <i>V&aacute;lida</i>.
								<mark>
									<span style="color:#E30513;"><b>Nota: </b></span>
									Cuando las Incidencias hayan sido resueltas, le solicitamos por favor se pida 
									<b>Certificar</b> las Incidencias, con el prop&oacute;sito de conocer
									si se ha quedado conforme con el trabajo de nuestros Ingenieros de Soporte.
								</mark>
							</td>
						</tr>
					</table>
...
<form class="form-horizontal" data-toggle="validator" role="form" id="solucion_incidencia_form"
 method="post" enctype="multipart/form-data" action="<?= PROJECTURLMENU; ?>portal/certificar_incidencia">
  ...
  <input type="hidden" id="solucionId_Form"   name="solucionId_Form"   value="" />
</form>
...
<script>
	...
	function certificarIncidencia(incidenciaId, resolucionId){
		...
		document.getElementById("solucionId_Form").value   = resolucionId;
