...
<head>
	...
	<link rel="manifest" href="https://lanuzasoft.com/app/views/portal_client/user-manifest.json" />
	...
	.jumbotron {
			background-color: #39A8D9;   /** #antiguo color #F4511E naranja */
			color: #fff;
			padding: 100px 25px;
	...
	.panel-heading {
			color: #fff !important;
			background-color: #39A8D9 !important;
			padding: 25px;
	...
	*/
	.navbar-default .navbar-toggle {
			border-color: #39A8D9; /** transparent; */
			color: #000 !important;
	}
	footer .glyphicon {
			font-size: 20px;
	...
	a.back-to-top {
		...
		right: 20px;
		bottom: 20px;
		background: #39A8D9 url("<?= APPIMAGEPATH; ?>up-arrow.png") no-repeat center 43%;
...
#showMeMore {
	...
	right: 50%;
	bottom: 20px;
	background: #39A8D9 url("<?= APPIMAGEPATH; ?>down-arrow.png") no-repeat center 43%;
	-webkit-border-radius: 30px;
	-moz-border-radius: 30px;
	border-radius: 30px;
}
...
<div id="welcome" class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-sm-6 col-xs-12 text-center">
			...
			<p>Usted hace parte de nuestra familia de Clientes a los que le ofrecemos nuestros servicios.</p>
...
<div id="equipo" class="container-fluid text-center">
	<br/>
	<h2>Conocer el Estado de su Equipo</h2>
	<h4>Nosotros realizamos el Servicio de <mark>Inventario de Equipos</mark> para nuestros clientes.</h4>
	<p>Esto consiste en que nosotros recopilamos la informaci&oacute;n sobre su equipo para que
	 Usted conozca en detalle el equipo con el que est&aacute; trabajando.</p>
...
<div id="incidencias" class="container-fluid text-center bg-grey">
	...
	<h4>&iquest;Alguna vez has tenido inconvenientes como estos... &quest; </h4>
	...
	<h2>Si es as&iacute;, somos la soluci&oacute;n perfecta para t&iacute;&excl; </h2>
	<h4>Si presentas alguno de estos inconvenientes, o cualquier otro, en tan solo 3 pasos podremos ayudarte:</h4>
	<br/>
	<div class="row text-center slideanim">
		<div class="col-sm-4">
				<span class="glyphicon glyphicon-home logo-small"></span>
				<p><strong>1.- Entras en nuestro Portal</strong></p>
		...
		<div class="col-sm-4">
				...
				<p><strong>2.- Creas una nueva Incidencia</strong></p>
				<p>Con un sencillo <mark>formulario</mark> nos cuentas en qu&eacute; deseas que te ayudemos.</p>
		</div>
		<div class="col-sm-4">
				<span class="glyphicon glyphicon-eye-open logo-small"></span>
				<p><strong>3.- Nuestros t&eacute;cnicos te asistir&aacute;n</strong></p>
				<p>Ya sea de forma <mark>presencial</mark> (en tu puesto de trabajo, Empresa o Casa) 
					...
					asignaremos a uno de nuestros t&eacute;cnicos para que te asista con tu inconveniente.</p>
		</div>
	</div>
	...
	<div class="row slideanim">
		...
		<div class="col-sm-4 col-xs-12">
			<div class="panel panel-default text-center">
				...
				<div class="panel-footer text-center">
					<img src="<?= APPIMAGEPATH; ?>celular.png" class="img-rounded" alt="Compu" width="95%" height="200">
				</div>
			</div>
		</div>
		<div class="col-sm-4 col-xs-12">
...
<div id="soportes" class="container-fluid bg-grey">
	...
	<div class="row">
		...
		<div class="col-sm-6 col-xs-12 text-center">
			<p>Mantente informado sobre el <strong>estatus actual</strong> de los Soportes, 
				el <strong>Hist&oacute;rico</strong> de Soportes previos 
				y cu&aacute;ndo ser&aacute; el pr&oacute;ximo
				<strong>Soporte programado</strong></p>
		</div>
		<div class="col-sm-3">
			&nbsp;
...
var menuArray = ["#welcome", "#equipo", "#incidencias", "#appTrello", "#soportes"];
