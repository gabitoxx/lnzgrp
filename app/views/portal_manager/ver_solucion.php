...
<div id="wholePage">
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="solucion_incidencia_form"
	 method="post" enctype="multipart/form-data" action="<?= PROJECTURLMENU; ?>portal/certificar_incidencia">
	  ...
	  <input type="hidden" id="certificar_incidenciaId_Form" name="certificar_incidenciaId_Form" value='<?= $solucion["incidenciaId"]; ?>' />
	  <input type="hidden" id="certificar_solucionId_Form"   name="certificar_solucionId_Form"   value='<?= $solucion["solucionId"]; ?>' />
						  ...
						  <div id="mantenimientoHardware-div" class="form-group">
							...
							<div class="col-sm-2">
								<div id="mantenimientoHardware-error" class="help-block">
									...
									<b>
<?php
										if ( $solucion["tipoTrabajoHardware"]==NULL || $solucion["tipoTrabajoHardware"]==""){
											echo "No Registra";
										} else {
											$solucion["tipoTrabajoHardware"];
										}
?>
									</b>
								</div>
						  ...
						  <div id="mantenimientoSoftware-div" class="form-group">
							...
							<div class="col-sm-2">
								<div id="mantenimientoSoftware-error" class="help-block">
									...
									<b>
<?php
										if ( $solucion["tipoTrabajoSoftware"]==NULL || $solucion["tipoTrabajoSoftware"]==""){
											echo "No Registra";
										} else {
											$solucion["tipoTrabajoSoftware"];
										}
?>
									</b>
								</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4" align="right">
			  <a href="<?php
			   if ( isset($volver_a_historico) )  	echo PROJECTURLMENU . "portal/historico_incidencias";
			   else 								echo PROJECTURLMENU . "portal/home";
...
<?php if ( isset($acciones) && $acciones == "no_acciones" ) {} else { ?>
			<div class="col-sm-4" align="center">
			  <button type="submit" class="btn btn-success btn-lg" onclick="javascript:certificar();return false;"
			   data-toggle="tooltip" data-placement="top" title="Dar por Finalizada y Certificar la Solución ofrecida por el Técnico">
...
<?php } ?>
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="print_incidencia_form"
	 method="post" enctype="multipart/form-data" action="<?= PROJECTURLMENU; ?>portal/imprimir_solucion_incidencia">
