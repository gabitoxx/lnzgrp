...
<?php
	if ( isset( $no_mis_equipos) ){
?>
		<h4 style="text-align:center;">
			<i>No hay registrado ning&uacute;n Historial de Equipos suyos hasta ahora.</i>
		</h4>
<?php
	} else {
?>
	<h4>
		<b><u><?= $cantidad_mis_equipos; ?></b></u> Equipo(s) registrado(s) a su nombre.
	</h4>
...
<?php
		...
		foreach ( $mis_equipos_info as $equipo) {
?>
...
?>
						<div class="equipoDiv">
							<div id="no-more-tables">
							    <table class="col-md-12 table-hover table-striped cf" style="font-size:14px;">
									<thead class="cf">
										<tr>
...
?>
										<tr>
											...
											<td data-title="Incidencia o Reporte Nº" align="center">
												<?php
...
?>
	<h4>
		<b><u><?= $cantidad_equipos; ?></b></u> Equipo(s) registrado(s) en su Empresa.
	</h4>
							    ...
							    <table class="col-md-12 table-hover table-striped cf" style="font-size:14px;">
									<thead class="cf">
										<tr>
											...
											<th>Trabajo Realizado</th>
											<th width="120px" align="center">Ing. de Soporte</th>
											<th width="100px" align="center">Incidencia Nº</th>
											<th align="center">Informaci&oacute;n extra</th>
										</tr>
									</thead>
									<tbody>
...
?>
										<tr>
											...
											<td data-title="Incidencia Nº" align="center">
												<?php
													if ($tx["incidenciaId"] == NULL || $tx["incidenciaId"] == ""){
														echo "No aplica";
													} else {
