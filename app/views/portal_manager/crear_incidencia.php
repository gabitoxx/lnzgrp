...
<form class="form-horizontal" data-toggle="validator" role="form" id="new_incidencia"
	  ...
	  <div id="givenname-div" class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group">
				...
				<select class="form-control" id="givenname" name="givenname" onblur="javascript:deshabilitarCombobox('equipos');return false;">
	...
	<div id="equipos-div" class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group">
				...
				<select class="form-control" id="equipos" name="equipos" onblur="javascript:deshabilitarCombobox('givenname');return false;">
	...
	<div class="col-sm-12">
		<h4 align="center"><i>
			<span style="color:#E30513">Complete los siguientes 2 campos:</span>
		</i></h4>
	  </div>
