...
<div class="row">
	...
	<div class="col-sm-8">
		Aquellas Incidencias que han sido <b>solucionadas</b> por alguno de nuestros Ingenieros de Soporte.
	</div>
</div>
<div class="row">
	<div class="col-sm-offset-2 col-sm-2">
...
<h4 style="text-align:center; color:#E30513;">
	...
	<i>Listado Hist&oacute;rico de <b>TODAS</b> las Incidencias <b>Finalizadas</b> de esta Empresa</i>
</h4>


<?php 
	
	if ( isset($no_incidenciasFinalizadas) ){
?>

	<div class="container">
		<h3>No existe Incidencias/Soportes t&eacute;cnicos Finalizados en el Sistema.
		</h3>
...
<?php 
		...
		unset($no_incidenciasFinalizadas);
...
<form id="resolucionIncidenciaForm" method="post" enctype="multipart/form-data" 
	action="<?= PROJECTURLMENU; ?>portal/ver_resolucion_incidencia">
		...
		<input type="hidden" id="no_acciones" name="no_acciones" value="no_acciones" />
