<?php if ( isset($incidencia_generada_correctamente) ){ ?>
	...
	<div class="container">
		...
		<h4>A la brevedad posible, uno de nuestros T&eacute;cnicos de Lanuza Group<br/> 
			  se pondr&aacute; en contacto con usted o con el Usuario del Equipo afectado de su Empresa; <br/> 
			  para darle Soporte al inconveniente descrito.<br/> 
			  <br/> 
			  Las Incidencias creadas de su Empresa las podr&aacute; ver en el men&uacute; izquierdo: <b>Ver Incidencias</b>,
