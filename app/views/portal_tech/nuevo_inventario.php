...
?>
	...
	<div class="row">
		...
		<div class="col-sm-3" align="right">
			<a href="<?= PROJECTURLMENU; ?>register">&iquest;No existe el Usuario&quest;: Crear Usuario nuevo</a>
		</div>
	</div>
...
<!-- ================================================================================================================= -->
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_user_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_buscar_usuario">
...
<!-- ================================================================================================================= -->
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_company_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_buscar_company">
...
<!-- ================================================================================================================= -->
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_userID_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_seleccionar_usuario">
	...
	<div class="container">
		<div class="row" style="background-color:#F9B233;">
			...
			<div class="col-sm-2" align="left">
				<a href="<?= PROJECTURLMENU; ?>tecnicos/nuevo_inventario">No usar este Usuario</a>
			</div>
		</div>
			...
			<table class="col-md-12 table-hover table-striped cf" style="font-size:12px;" frame="hsides"><!-- <table frame="box"> -->
				<thead class="cf">
					<tr>
						...
						<th class="numeric">TeamViewer ID</th>
...
<!-- ================================================================================================================= -->
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_userID_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_seleccionar_empresa">
...
<!-- ================================================================================================================= -->
	<div class="container">
		<div class="row" style="background-color:#F9B233;">
			...
			<div class="col-sm-2" align="left">
				<a href="<?= PROJECTURLMENU; ?>tecnicos/nuevo_inventario">No usar esta Empresa</a>
			</div>
		</div>
		<div class="row" style="background-color:#F9B233;">
			<div class="col-sm-1" align="right">
...
?>
		...
		<form data-toggle="validator" role="form" id="inventario_new_eq_form" method="post"
		 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_nuevo_equipo">
...
<!-- =============================================================================================== -->
			...
			<div class="row">
				...
				<div class="col-sm-4" align="left">
					<br/><br/>
					<a href="<?= PROJECTURLMENU; ?>tecnicos/nuevo_inventario" class="btn btn-link">
