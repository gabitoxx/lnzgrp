<?php
	$infoEmpresaUsuario = "<b>Empresa:</b> " . $companyInfo 
			. "<br/><b>Usuario:</b>" . $usuario
			. "<br/><b>ID en Sistema:</b>" . $equipoId
			;
?>
...
<div class="container">
	...
	<div class="row" style="background-color:#F9B233;">
		...
		<div class="col-sm-2">
			<a href="<?= PROJECTURLMENU; ?>tecnicos/actualizar_inventario">No actualizar este Equipo</a>
		</div>
	</div>
	...
	<form data-toggle="validator" role="form" id="files_inventario" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_actualizar_archivos">
			...
			<div class="col-sm-12" align="center">
				<button type="button" class="btn btn-success btn-lg" onclick="javascript:uploadFiles();"
				 data-toggle="tooltip" data-placement="bottom" title="PRIMERO Adjunte TODOS los Archivos, luego pulsar ESTE BOTÓN">
				   <span class="glyphicon glyphicon-floppy-open"></span> Subir y Procesar Archivos .CSV </button>
			</div>
		</div>
			...
			<div class="col-sm-6" align="center">
				<button type="button" class="btn btn-danger btn-lg" onclick="javascript:manualForm();"
				 data-toggle="tooltip" data-placement="bottom" title="SOLO EN CASO de que NO pueda generar los SCRIPTS con el programa propiedad de LanuzaGroup&reg;">
				   <span class="glyphicon glyphicon-edit"></span> Levantamiento manual de info (Actualizaci&oacute;n) 
				</button>
			</div>
			<div class="col-sm-6" align="center">
				<u><b>NOTA:</b></u>
		...
		<div class="row">
			...
			<div class="col-sm-12" align="center">
				<b>--&gt;NOTA:&lt;--</b>
				<i>Ninguna de estas 2 opciones <b>(
					<span style="color:#5cb85c;">Scripts</span>
					o 
					<span style="color:#d9534f;">Lev. manual</span>
					)</b>
					eliminar&aacute;n la data previamente cargada.
					Esto es una ACTUALIZACI&Oacute;N que permitir&aacute; obtener
					data Hist&oacute;rica del Equipo; &uacute;til para conocer
					progresivamente el estado de los Equipos
				</i>
				y as&iacute; poder generar Reportes con info 
				&uacute;til para la Gerencia de las Empresas.
				<br/><br/>
			</div>
		</div>
		<hr/>
...
<form data-toggle="validator" role="form" id="manual_inventario" method="post"
 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/inventario_manual_actualizar">

	<input type="hidden" id="equipoId" 	   		 name="equipoId" 	   		value="<?= $equipoId; ?>" />
	<input type="hidden" id="equipoInfoId" 		 name="equipoInfoId" 		value="<?= $equipoInfoId; ?>" />
	<input type="hidden" id="infoEmpresaUsuario" name="infoEmpresaUsuario" 	value="<?= $infoEmpresaUsuario; ?>" />
</form>
