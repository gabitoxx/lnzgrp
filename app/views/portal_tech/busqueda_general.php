...
<div class="container">
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="busqueda_general_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/busqueda_general">

		<div class="row">
			<div class="col-sm-12" align="center" style="padding: 12px 20px 12px 40px; font-size: 18px; color: #E30513;">
				<i>Seleccione un "Objeto" a buscar, indique las opciones o palabras claves y presione ENTER </i><b>Buscar</b>.
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-4" style="padding: 12px 20px 12px 40px; font-size: 16px;">
		...
		<div id="incidencias" class="row well well-lg">
			...
			<div class="row">
				<div class="col-sm-12" align="left" style="padding: 12px 20px 12px 40px; font-size: 16px;">
					<b>Incidencias:</b> para buscar <b>"Incidencias"</b> registradas en el Sistema, puede indicar
					SOLO UNA de las siguientes opciones:
					<br/><br/>
					<span style="background-color:#F9B233;">
						1.- La manera m&aacute;s directa de encontrar una Incidencia en particular 
						es introduciendo el <b>#ID de la Incidencia</b>, ya que es el 
...
?>
	...
	<script>
		$("#peopleFound").css({'visibility':'visible', 'position':'absolute', 'top': '480px'});
	</script>
...
?>
	...
	<script>
		$("#companiesFound").css({'visibility':'visible', 'position':'absolute', 'top': '480px'});
	</script>
...
?>
			...
			<table class="col-md-12 table-hover table-striped cf" style="font-size:12px;">
				...
				<tbody>
					...
					<tr>
						...
						<td data-title="Fallas y Comentarios"><?php echo $incidencia["falla"]; ?></td>
	...
	<script>
		$("#incidentFound").css({'visibility':'visible', 'position':'absolute', 'top': '1210px'});
