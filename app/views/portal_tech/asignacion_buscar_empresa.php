<?php 
	...
	if ( isset($procesoParte) 
		...
		echo "<script>";
		echo " var searchURL = '" . PROJECTURLMENU . "tecnicos/asignacion_seleccionar_empresa';" ;
		echo "</script>";
?>
	<style>
	...
	<div class="row">
		<div class="col-sm-12" align="center" style="padding: 12px 20px 12px 40px; font-size: 18px;">
			Aqu&iacute; usted podr&aacute; <b>asignar un <i>Equipo</i> a un Usuario</b> de una <u>Empresa</u> en particular.	
		</div>		
	</div>
...
<!-- ================================================================================================================= -->
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_company_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/asignacion_seleccionar_empresa">
		
		<h4 style="text-align:center; color:#E30513;">
			<span class="glyphicon glyphicon-briefcase"></span> 
			&rarr; 
			<span class="glyphicon glyphicon-blackboard"></span> 
			<i>Asignaci&oacute;n de Equipos de Empresa:</i>&nbsp;&nbsp;&nbsp;</h4>
...
<!-- ================================================================================================================= -->
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12" align="right" style="padding: 12px 20px 12px 40px; font-size: 16px;">
				<i>Empresas encontradas:</i> Seleccione una para continuar con la <b>Asignaci&oacute;n</b>...
			</div>
		</div>
	...
	<form class="form-horizontal" data-toggle="validator" role="form" id="search_companyID_form" method="post"
	 enctype="multipart/form-data" action="<?= PROJECTURLMENU ?>tecnicos/asignacion_equipos_de_empresa">
