...
<script>
	...
	function sanitizarTodosLosCampos(){
    $("#laborDelEquipo").val( sanitize($("#laborDelEquipo").val()) );
    $("#variableEndogena").val( sanitize($("#variableEndogena").val()) );
    $("#variableExogenaTecnica").val( sanitize($("#variableExogenaTecnica").val()) );
    $("#variableExogenaHumana").val( sanitize($("#variableExogenaHumana").val()) );
    $("#mantenimientoHardware").val( sanitize($("#mantenimientoHardware").val()) );
    $("#mantenimientoSoftware").val( sanitize($("#mantenimientoSoftware").val()) );
    $("#acompanamientoJunior").val( sanitize($("#acompanamientoJunior").val()) );
  }
