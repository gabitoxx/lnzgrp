	...
	if ( isset($companyInfo) ){  ?>
		...
		<div class="row">
			...
			<div class="col-sm-2" align="right" style="background-color:#F9B233;">
				<a href="<?= PROJECTURLMENU; ?>tecnicos/asignacion">Buscar otra Empresa</a>
			</div>
		</div>
		<br/><br/>
...
<?php
	echo "<script>";
	echo " var searchURL  = '" . PROJECTURLMENU . "tecnicos/desasociar_equipo_usuario';" ;
	echo " var searchURL2 = '" . PROJECTURLMENU . "tecnicos/asociar_equipo_usuario';" ;
	echo "</script>";
?>
