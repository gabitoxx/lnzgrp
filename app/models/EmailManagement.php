	...
	public static function recordarPassword($user){
		...
		try {
			...
			$mensaje="
					...
					. "<br/>Contrase&ntilde;a: <b>1234567</b>"
          . "<br/>ATENCIÓN: Se recomienda que, una vez ingrese con esta contraseña temporal, se dirija al menú, la opción 'Actualizar Mis Datos', y cambie esta contraseña por una de su preferencia. Tome atenta nota de la Fortaleza mínima que debe cumplir su nueva contraseña (se especifica en la sección Contraseña Nueva)."
					. "<br/><br/><br/>"
