...
class Incidencias {
	...
	public static function insert($userId, $equipoIdIncidencia, $tipoFalla, 
      ...
      /**
       * se Sanitizan las entradas de texto del usuario
       * el JSON se sanitizó desde le javascript -> app\views\js\funcionesGenericas.js -> sanitize()
       * fue ofuscado, el original se conserva en Lanuza Group - pendientes.txt
       */
      $observaciones = Utils::sanitize( $observaciones, 2096 );
	...
	public static function resolverIncidencia( $incidenciaId, $tecnicoId, 
      ...
      $laborDelEquipo          = Utils::sanitize( $laborDelEquipo, 512 );
      $variableEndogena        = Utils::sanitize( $variableEndogena, 2048 );
      $variableExogenaTecnica  = Utils::sanitize( $variableExogenaTecnica, 2048 );
      $variableExogenaHumana   = Utils::sanitize( $variableExogenaHumana, 2048 );
      $mantenimientoHardware   = Utils::sanitize( $mantenimientoHardware, 4098 );
      $mantenimientoSoftware   = Utils::sanitize( $mantenimientoSoftware, 4098 );
      $acompanamientoJunior    = Utils::sanitize( $acompanamientoJunior, 4098 );
